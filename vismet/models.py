...
class PixelData(models.Model):
    ...
    date = models.DateField()
    evapo = models.FloatField('evapotranspiração', default=None, null=True, blank=True)
    minTemp = models.FloatField('temperatura mínima', default=None, null=True, blank=True)
    maxTemp = models.FloatField('temperatura máxima', default=None, null=True, blank=True)
    ocis = models.FloatField('radiação de onda curta incidente à superficie', default=None, null=True, blank=True)
    precip = models.FloatField('precipitação', default=None, null=True, blank=True)
    rnof = models.FloatField('escoamento superficial', default=None, null=True, blank=True)
    tp2m = models.FloatField('temperatura a 2m', default=None, null=True, blank=True)
